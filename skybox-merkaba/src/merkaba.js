...
// shaded moon -- side away from light picks up AmbientLight's color.
	let pyramidTexture
	pyramidTexture = THREE.TextureLoader( 'patterns/p_18.jpg' );
	// var moonMaterial = new THREE.MeshLambertMaterial( { map: pyramidTexture } );
	// var moon = new THREE.Mesh( sphereGeom.clone(), moonMaterial );
	// moon.position.set(0, 50, 0);
	// scene.add( moon );	

	let material
	material = new THREE.MeshLambertMaterial( { map: pyramidTexture } )
